...
ToolRegistry.register({
  name: 'postRegistrationregister',
  category: 'registration',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/auth/register',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/auth/register`;
...
ToolRegistry.register({
  name: 'postRegistrationverifyEmail',
  category: 'registration',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/auth/verify-email',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/auth/verify-email`;
...
ToolRegistry.register({
  name: 'postRegistrationresendVerification',
  category: 'registration',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/auth/resend-verification',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/auth/resend-verification`;
...
ToolRegistry.register({
  name: 'postRegistrationforgotPassword',
  category: 'registration',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/auth/forgot-password',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/auth/forgot-password`;
...
ToolRegistry.register({
  name: 'postRegistrationresetPassword',
  category: 'registration',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/auth/reset-password',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/auth/reset-password`;
