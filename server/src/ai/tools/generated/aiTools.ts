...
ToolRegistry.register({
  ...
  description: 'Auto-generated tool for POST /api/ai/run',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/ai/run`;
...
ToolRegistry.register({
  ...
  category: 'ai',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/ai/history',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/ai/history`;
...
ToolRegistry.register({
  ...
  category: 'ai',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/ai/history',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'ai',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/ai/history/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/ai/history/:id`;
...
ToolRegistry.register({
  name: 'deleteAihistoryid',
  category: 'ai',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/ai/history/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
