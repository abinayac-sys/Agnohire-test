...
ToolRegistry.register({
  name: 'listJobs',
  category: 'publicCareers',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/public/careers/:tenantSlug/jobs',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/public/careers/:tenantSlug/jobs`;
...
ToolRegistry.register({
  ...
  category: 'publicCareers',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/public/careers/:tenantSlug/jobs/:jobId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/public/careers/:tenantSlug/jobs/:jobId`;
...
ToolRegistry.register({
  ...
  category: 'publicCareers',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/public/careers/:tenantSlug/jobs/:jobId/apply',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/public/careers/:tenantSlug/jobs/:jobId/apply`;
