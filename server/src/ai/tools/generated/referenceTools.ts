...
ToolRegistry.register({
  name: 'getReferencesectors',
  category: 'reference',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/reference/sectors',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/reference/sectors`;
...
ToolRegistry.register({
  name: 'getReferencedomains',
  category: 'reference',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/reference/domains',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/reference/domains`;
...
ToolRegistry.register({
  ...
  category: 'reference',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/reference/users',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/reference/users`;
