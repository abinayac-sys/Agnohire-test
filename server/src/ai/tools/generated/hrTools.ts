...
ToolRegistry.register({
  ...
  category: 'hr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/hr/queue',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/hr/queue`;
...
ToolRegistry.register({
  name: 'getProcessedQueue',
  category: 'hr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/hr/processed',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/hr/processed`;
...
ToolRegistry.register({
  ...
  category: 'hr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/hr/report/:candidateId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/hr/report/:candidateId`;
...
ToolRegistry.register({
  name: 'processHrApproval',
  category: 'hr',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/hr/process/:interviewId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/hr/process/:interviewId`;
...
ToolRegistry.register({
  name: 'deleteHrApproval',
  category: 'hr',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/hr/process/:interviewId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
