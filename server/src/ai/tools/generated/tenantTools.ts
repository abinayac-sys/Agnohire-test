...
ToolRegistry.register({
  ...
  category: 'tenant',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/tenant/usage',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/tenant/usage`;
...
ToolRegistry.register({
  name: 'getTenantfeatures',
  category: 'tenant',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/tenant/features',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/tenant/features`;
...
ToolRegistry.register({
  name: 'patchTenanttimezone',
  category: 'tenant',
  allowedRoles: [ROLES.ADMIN, ROLES.TENANT_OWNER, ROLES.SUPERADMIN],
  description: 'Auto-generated tool for PATCH /api/tenant/timezone',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/tenant/timezone`;
...
ToolRegistry.register({
  name: 'postTenantinvites',
  category: 'tenant',
  allowedRoles: [ROLES.ADMIN, ROLES.TENANT_OWNER, ROLES.SUPERADMIN],
  description: 'Auto-generated tool for POST /api/tenant/invites',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/tenant/invites`;
...
ToolRegistry.register({
  name: 'getTenantinvites',
  category: 'tenant',
  allowedRoles: [ROLES.ADMIN, ROLES.TENANT_OWNER, ROLES.SUPERADMIN],
  description: 'Auto-generated tool for GET /api/tenant/invites',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  name: 'postTenantinvitesAccept',
  category: 'tenant',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/tenant/invites/accept',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/tenant/invites/accept`;
