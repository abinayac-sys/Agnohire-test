...
ToolRegistry.register({
  ...
  description: 'Auto-generated tool for GET /api/analytics/dashboard',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/analytics/dashboard`;
...
ToolRegistry.register({
  ...
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for GET /api/analytics/insights',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/analytics/insights`;
...
ToolRegistry.register({
  ...
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for GET /api/analytics/export',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/analytics/export`;
...
ToolRegistry.register({
  ...
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for GET /api/analytics/snapshots',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/analytics/snapshots`;
...
ToolRegistry.register({
  ...
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for POST /api/analytics/snapshots',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for DELETE /api/analytics/snapshots/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/analytics/snapshots/:id`;
...
ToolRegistry.register({
  name: 'exportSnapshotPDF',
  category: 'analytics',
  permissions: [PERMISSIONS.ANALYTICS_VIEW],
  description: 'Auto-generated tool for GET /api/analytics/snapshots/:id/pdf',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/analytics/snapshots/:id/pdf`;
