...
ToolRegistry.register({
  name: 'getBoard',
  category: 'pipeline',
  permissions: [PERMISSIONS.PIPELINE_VIEW],
  description: 'Auto-generated tool for GET /api/pipeline/board',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/pipeline/board`;
...
ToolRegistry.register({
  ...
  category: 'pipeline',
  permissions: [PERMISSIONS.PIPELINE_VIEW],
  description: 'Auto-generated tool for GET /api/pipeline/applications/:id/notes',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/pipeline/applications/:id/notes`;
...
ToolRegistry.register({
  name: 'addNote',
  category: 'pipeline',
  permissions: [PERMISSIONS.PIPELINE_MANAGE],
  description: 'Auto-generated tool for POST /api/pipeline/applications/:id/notes',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'pipeline',
  permissions: [PERMISSIONS.PIPELINE_MANAGE],
  description: 'Auto-generated tool for DELETE /api/pipeline/applications/:id/notes/:noteId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/pipeline/applications/:id/notes/:noteId`;
...
ToolRegistry.register({
  ...
  category: 'pipeline',
  permissions: [PERMISSIONS.PIPELINE_MANAGE],
  description: 'Auto-generated tool for PATCH /api/pipeline/applications/:id/stage',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/pipeline/applications/:id/stage`;
