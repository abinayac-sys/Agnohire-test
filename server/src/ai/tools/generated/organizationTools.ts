...
ToolRegistry.register({
  ...
  publicTool: true,
  description: 'Auto-generated tool for GET /api/organizations',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/organizations`;
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/organizations',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/organizations/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/organizations/:id`;
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for PATCH /api/organizations/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/organizations/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/organizations/:id/members',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/organizations/:id/members`;
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/organizations/:id/members',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for PATCH /api/organizations/:id/members/:userId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/organizations/:id/members/:userId`;
...
ToolRegistry.register({
  ...
  category: 'organization',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/organizations/:id/members/:userId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
