...
ToolRegistry.register({
  ...
  category: 'attachment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/files',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/files`;
...
ToolRegistry.register({
  ...
  category: 'attachment',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/files/:id/download',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/files/:id/download`;
