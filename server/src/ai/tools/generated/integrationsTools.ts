...
ToolRegistry.register({
  ...
  publicTool: true,
  description: 'Auto-generated tool for GET /api/integrations',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/integrations`;
...
ToolRegistry.register({
  ...
  category: 'integrations',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/integrations/:providerId/connect',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/integrations/:providerId/connect`;
...
ToolRegistry.register({
  ...
  category: 'integrations',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/integrations/:providerId/disconnect',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/integrations/:providerId/disconnect`;
...
ToolRegistry.register({
  ...
  category: 'integrations',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/integrations/:providerId/sync',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/integrations/:providerId/sync`;
...
ToolRegistry.register({
  ...
  category: 'integrations',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/integrations/:providerId/test',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/integrations/:providerId/test`;
