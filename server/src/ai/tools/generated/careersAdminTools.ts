...
ToolRegistry.register({
  name: 'listJobs',
  category: 'careersAdmin',
  permissions: [PERMISSIONS.JOB_EDIT],
  description: 'Auto-generated tool for GET /api/careers-admin/jobs',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/careers-admin/jobs`;
...
ToolRegistry.register({
  name: 'setSalaryVisibility',
  category: 'careersAdmin',
  permissions: [PERMISSIONS.JOB_EDIT],
  description: 'Auto-generated tool for PATCH /api/careers-admin/jobs/:jobId/salary-visibility',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/careers-admin/jobs/:jobId/salary-visibility`;
