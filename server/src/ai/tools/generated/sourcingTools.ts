...
ToolRegistry.register({
  name: 'listReferrals',
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_VIEW],
  description: 'Auto-generated tool for GET /api/sourcing/referrals',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/sourcing/referrals`;
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_VIEW],
  description: 'Auto-generated tool for POST /api/sourcing/referrals',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  name: 'updateReferral',
  category: 'sourcing',
  permissions: [PERMISSIONS.REFERRAL_MANAGE],
  description: 'Auto-generated tool for PATCH /api/sourcing/referrals/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/sourcing/referrals/:id`;
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.REFERRAL_MANAGE],
  description: 'Auto-generated tool for DELETE /api/sourcing/referrals/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_VIEW],
  description: 'Auto-generated tool for GET /api/sourcing/channels',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/sourcing/channels`;
...
ToolRegistry.register({
  ...
  description: 'Auto-generated tool for POST /api/sourcing/channels',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_MANAGE],
  description: 'Auto-generated tool for PATCH /api/sourcing/channels/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/sourcing/channels/:id`;
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_MANAGE],
  description: 'Auto-generated tool for POST /api/sourcing/channels/:id/sync',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/sourcing/channels/:id/sync`;
...
ToolRegistry.register({
  ...
  category: 'sourcing',
  permissions: [PERMISSIONS.SOURCING_MANAGE],
  description: 'Auto-generated tool for DELETE /api/sourcing/channels/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
