...
ToolRegistry.register({
  name: 'getAssessment',
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/assessment/:token',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/assessment/:token`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/start',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/start`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/answer',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/answer`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/violation',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/violation`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/snapshot',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/snapshot`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/recording',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/recording`;
...
ToolRegistry.register({
  ...
  category: 'publicAssessment',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/assessment/:token/submit',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/assessment/:token/submit`;
