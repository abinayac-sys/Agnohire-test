...
ToolRegistry.register({
  ...
  permissions: [PERMISSIONS.CANDIDATE_VIEW],
  description: 'Auto-generated tool for GET /api/applications',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/applications`;
...
ToolRegistry.register({
  ...
  description: 'Auto-generated tool for POST /api/applications',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'application',
  permissions: [PERMISSIONS.CANDIDATE_EDIT],
  description: 'Auto-generated tool for PATCH /api/applications/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/applications/:id`;
...
ToolRegistry.register({
  ...
  category: 'application',
  permissions: [PERMISSIONS.CANDIDATE_EDIT],
  description: 'Auto-generated tool for POST /api/applications/:id/score',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/applications/:id/score`;
...
ToolRegistry.register({
  ...
  category: 'application',
  permissions: [PERMISSIONS.CANDIDATE_EDIT],
  description: 'Auto-generated tool for DELETE /api/applications/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
