...
ToolRegistry.register({
  name: 'listMyInterviews',
  category: 'candidatePortal',
  allowedRoles: [ROLES.CANDIDATE],
  description: 'Auto-generated tool for GET /api/me/interviews',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/me/interviews`;
...
ToolRegistry.register({
  name: 'downloadMyReport',
  category: 'candidatePortal',
  allowedRoles: [ROLES.CANDIDATE],
  description: 'Auto-generated tool for GET /api/me/interviews/:id/report',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/me/interviews/:id/report`;
...
ToolRegistry.register({
  ...
  category: 'candidatePortal',
  allowedRoles: [ROLES.CANDIDATE],
  description: 'Auto-generated tool for GET /api/me/applications',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/me/applications`;
...
ToolRegistry.register({
  ...
  category: 'candidatePortal',
  allowedRoles: [ROLES.CANDIDATE],
  description: 'Auto-generated tool for GET /api/me/offers',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/me/offers`;
