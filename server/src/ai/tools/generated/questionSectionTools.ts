...
ToolRegistry.register({
  name: 'listSections',
  category: 'questionSection',
  permissions: [PERMISSIONS.QUESTION_BANK_VIEW],
  description: 'Auto-generated tool for GET /api/question-sections',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/question-sections`;
...
ToolRegistry.register({
  name: 'createSection',
  category: 'questionSection',
  permissions: [PERMISSIONS.QUESTION_BANK_MANAGE],
  description: 'Auto-generated tool for POST /api/question-sections',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'questionSection',
  permissions: [PERMISSIONS.QUESTION_BANK_MANAGE],
  description: 'Auto-generated tool for PATCH /api/question-sections/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/question-sections/:id`;
...
ToolRegistry.register({
  ...
  category: 'questionSection',
  permissions: [PERMISSIONS.QUESTION_BANK_MANAGE],
  description: 'Auto-generated tool for DELETE /api/question-sections/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
