...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/gdpr/summary',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/gdpr/summary`;
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/gdpr/requests',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/requests`;
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/gdpr/requests',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/gdpr/requests/:id/process',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/requests/:id/process`;
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/gdpr/consent',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/consent`;
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/gdpr/consent',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/gdpr/retention',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/retention`;
...
ToolRegistry.register({
  name: 'upsertRetention',
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/gdpr/retention',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
...
ToolRegistry.register({
  ...
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/gdpr/retention/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/retention/:id`;
...
ToolRegistry.register({
  name: 'exportCandidate',
  category: 'gdpr',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/gdpr/export/:candidateId',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/gdpr/export/:candidateId`;
