...
ToolRegistry.register({
  ...
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/audit',
  parameters: {
    type: 'object',
    properties: {
  ...
  execute: async (args, ctx, _req) => {
    ...
    let url = `http://localhost:${port}/api/audit`;
...
ToolRegistry.register({
  ...
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/audit/facets',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/audit/facets`;
...
ToolRegistry.register({
  ...
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/audit/export',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/audit/export`;
...
ToolRegistry.register({
  name: 'deleteAuditLogsBulk',
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for POST /api/audit/delete-bulk',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/audit/delete-bulk`;
...
ToolRegistry.register({
  ...
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for GET /api/audit/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
  ...
  execute: async (args, ctx, _req) => {
    const port = process.env.PORT || 4000;
    let url = `http://localhost:${port}/api/audit/:id`;
...
ToolRegistry.register({
  ...
  category: 'audit',
  publicTool: true,
  description: 'Auto-generated tool for DELETE /api/audit/:id',
  parameters: {
    type: 'object',
    properties: {
      body: { type: 'object', description: 'Request payload' },
