...
export const adpProvider: IntegrationProviderDef = {
  id: 'adp',
  categoryId: 'hrms',
  name: 'ADP Workforce Now',
  description: 'ADP Workforce Now integration.',
  icon: <img src="https://www.google.com/s2/favicons?domain=adp.com&sz=64" alt="ADP Workforce Now Logo" className="w-8 h-8 object-contain rounded-md" />,
  getDefaultState: () => ({
    tenantId: '',
    clientId: '',
    clientSecret: '',
  ...
  getWizardSteps: ({ state, updateState, integration, testResult, setTestResult, setIsTesting }) => [
    {
      title: 'ADP Workforce Now Credentials',
      ...
      onNext: async () => {
        ...
        setTestResult(null);
        try {
          const res = await api.post(`/admin/integrations/adp/test`, {
            tenantId: state.tenantId,
