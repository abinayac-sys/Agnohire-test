...
export const oraclehcmProvider: IntegrationProviderDef = {
  id: 'oraclehcm',
  categoryId: 'hrms',
  name: 'Oracle HCM Cloud',
  description: 'Oracle Human Capital Management Cloud.',
  icon: <img src="https://www.google.com/s2/favicons?domain=oracle.com&sz=64" alt="Oracle HCM Cloud Logo" className="w-8 h-8 object-contain rounded-md" />,
  getDefaultState: () => ({
    tenantId: '',
    clientId: '',
    clientSecret: '',
  ...
  getWizardSteps: ({ state, updateState, integration, testResult, setTestResult, setIsTesting }) => [
    {
      title: 'Oracle HCM Cloud Credentials',
      ...
      onNext: async () => {
        ...
        setTestResult(null);
        try {
          const res = await api.post(`/admin/integrations/oraclehcm/test`, {
            tenantId: state.tenantId,
