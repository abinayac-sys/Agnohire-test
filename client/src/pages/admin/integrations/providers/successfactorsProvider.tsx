...
export const successfactorsProvider: IntegrationProviderDef = {
  id: 'successfactors',
  categoryId: 'hrms',
  name: 'SAP SuccessFactors',
  description: 'SAP SuccessFactors HCM Integration.',
  icon: <img src="https://www.google.com/s2/favicons?domain=sap.com&sz=64" alt="SAP SuccessFactors Logo" className="w-8 h-8 object-contain rounded-md" />,
  getDefaultState: () => ({
    tenantId: '',
    clientId: '',
    clientSecret: '',
  ...
  getWizardSteps: ({ state, updateState, integration, testResult, setTestResult, setIsTesting }) => [
    {
      title: 'SAP SuccessFactors Credentials',
      ...
      onNext: async () => {
        ...
        setTestResult(null);
        try {
          const res = await api.post(`/admin/integrations/successfactors/test`, {
            tenantId: state.tenantId,
